...
<asp:Content runat="server" ContentPlaceHolderID="DashContent">
    ...
    <div class="Settings-Page col-xl-4 col-lg-6 col-md-8 col-sm-10" style="justify-content:center">
            ...
            <div class="input-group mb-4">
                <br />
                <input type="text" class="form-control rounded" placeholder="New Username" aria-label="New Username" aria-describedby="button-addon1">
                <div class="input-group-append">
                    <button class="btn btn-dark" type="button" id="button-addon1">Submit</button>
                </div>
            </div>
            ...
            <asp:button runat="server" ID="light" type="button" class="btn btn-light border" Text="Light Mode" OnCommand="light_Click" />
